...
# 输出图像的所需尺寸
imsize = (512,512) if torch.cuda.is_available() else (128,128)  # 如果没有GPU，请使用小尺寸
...
style_img = image_loader(r"style5.jpg")
content_img = image_loader(r"content.jpg")
...
def run_style_transfer(cnn, normalization_mean, normalization_std,
                       ...
                       style_weight=1e9, content_weight=0.1):
